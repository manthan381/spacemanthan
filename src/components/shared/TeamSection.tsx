...
const team = [
  ...
  },
  {
    ...
    qual: "M. Comm",
    descr:
      "Kajal Singh, a Mass Communication expert, rises to prominence as Director of Space Manthan. Her inspiring journey from academia to leading a thriving design firm showcases the fusion of education, creativity, and entrepreneurship, driving excellence and innovation.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 gap-5">
          {team.map((member, i) => (
            <motion.div
              key={member.name}
              className="bg-white rounded-none overflow-hidden shadow group"
